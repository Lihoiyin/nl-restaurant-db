...
router.get('/api/my/profile', authenticateUser, (await import('./controllers/api/auth/profile.js')).default)

router.get('/api/couponOnUsers', authenticateUser, (await import('./controllers/api/couponOnUsers/all.js')).default)
router.post('/api/couponOnUsers/:couponId', authenticateUser, (await import('./controllers/api/couponOnUsers/new.js')).default)
router.get('/api/couponOnUsers/:id', authenticateUser, (await import('./controllers/api/couponOnUsers/show.js')).default)
router.delete('/api/couponOnUsers/:id', authenticateUser, (await import('./controllers/api/couponOnUsers/delete.js')).default)
...
router.put('/api/setOnOrders/:id', authenticateUser, (await import('./controllers/api/setOnOrders/update.js')).default)
router.post('/api/setOnOrders', authenticateUser, (await import('./controllers/api/setOnOrders/new.js')).default)
router.get('/api/setOnOrders/:id', authenticateUser, (await import('./controllers/api/setOnOrders/show.js')).default)
router.delete('/api/setOnOrders/:id', authenticateUser, (await import('./controllers/api/setOnOrders/delete.js')).default)

router.put('/api/orders', authenticateUser, (await import('./controllers/api/orders/update.js')).default)
router.post('/api/orders', authenticateUser, (await import('./controllers/api/orders/new.js')).default)
router.get('/api/orders/:id', authenticateUser, (await import('./controllers/api/orders/show.js')).default)
router.delete('/api/orders/:id', authenticateUser, (await import('./controllers/api/orders/delete.js')).default)
router.get('/api/cart', authenticateUser, (await import('./controllers/api/orders/cart.js')).default)
